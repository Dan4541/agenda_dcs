        ...
        <div class="col-4 col-s-4 mx-auto">
          <form action="{{ route('login') }}" method="POST">
            ...
            <div class="form-outline mb-4">
              <input type="email" id="form3Example3" name="lemail" class="form-control form-control-lg"
            ...
            <div class="form-outline mb-3">
              <input type="password" id="form3Example4" name="lpassword" class="form-control form-control-lg"
